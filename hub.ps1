...
while ($true) {
    ...
    switch ($c) {
        ...
        'W' { Start-Process -FilePath 'cmd.exe' -ArgumentList '/c', (Join-Path $ChatRoot 'setup-work-shortcuts.bat') -WorkingDirectory $ChatRoot -Wait; break }
        'w' { Start-Process -FilePath 'cmd.exe' -ArgumentList '/c', (Join-Path $ChatRoot 'setup-work-shortcuts.bat') -WorkingDirectory $ChatRoot -Wait; break }
        'E' { Start-Process -FilePath 'cmd.exe' -ArgumentList '/c', (Join-Path $ChatRoot 'fix-hebrew-chat.bat') -WorkingDirectory $ChatRoot -Wait; break }
        'e' { Start-Process -FilePath 'cmd.exe' -ArgumentList '/c', (Join-Path $ChatRoot 'fix-hebrew-chat.bat') -WorkingDirectory $ChatRoot -Wait; break }
